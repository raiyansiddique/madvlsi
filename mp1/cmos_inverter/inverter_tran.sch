...
C {madvlsi/vsource.sym} -220 -70 0 0 {name=Vin
value="pulse(0 1.8 1ns 1ns 1ns 4ns 10ns)"}
C {madvlsi/gnd.sym} -220 -40 0 0 {name=l3 lab=GND}
C {madvlsi/vsource.sym} -220 -190 0 0 {name=Vdd
value=1.8}
C {madvlsi/gnd.sym} -220 -160 0 0 {name=l4 lab=GND}
C {madvlsi/vdd.sym} -220 -220 0 0 {name=l5 lab=VDD}
...
C {devices/code_shown.sym} 260 -30 0 0 {name=SPICE only_toplevel=false value= ".tran 0.01n 1u
.save all"}
C {devices/lab_pin.sym} -20 -90 0 0 {name=p1 sig_type=std_logic lab=Vin}
C {devices/lab_pin.sym} -220 -100 2 0 {name=p2 sig_type=std_logic lab=Vin}
